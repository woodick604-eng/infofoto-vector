...
APP_VERSION = "2.53 (Gemini 3.0 Flash Enabled)"
...
def generate_ai_descriptions(evolucio: str, image_files: List[str], sid: str = None) -> Dict[str, str]:
    ...
    # Models update: Usem noms reals de l'API (validats amb nova clau)
    # Prioritzem Gemini 3 Flash (Preview) segons petició, amb fallbacks robustos a 2.5 i 2.0
    ...
    for model_name in models_to_try:
        try:
            update_status(f"Generant descripcions amb {model_name}...", sid)
    ...
    return {f: "Error crític: Tots els models IA han fallat. Intenta-ho de nou." for f in image_files}
